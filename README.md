...
* V1.5 Integracion de CSRF globalmente y mejora en estructuracion y seguridad del proyecto
* v1.9 Login con Google
* v2.0 Verificación de autenticidad de datos mediante firmas digitales
* Preparacion para produccion: Docker, firmas y HTTPS
